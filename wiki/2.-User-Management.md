...
Parallax supports multiple users, each with their own set of projects. Users are created and managed from the **Projects** page (`/projects`).

---

## Creating a User

When you first open Parallax, the left panel of the Projects page shows the user management area.
...
- The currently selected user is persisted in your browser's `localStorage` (`parallax-current-user`), so it survives page refreshes and browser restarts
