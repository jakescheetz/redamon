...
For installation instructions, environment setup, build commands, and first launch, see the **[README.md](https://github.com/samugit83/parallax#quick-start)** in the main repository.

---

## What's Next?

Once Parallax is running at **http://localhost:3000**:
