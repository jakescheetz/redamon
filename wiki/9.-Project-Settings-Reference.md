...
Every project in Parallax has **180+ configurable parameters** that control the behavior of each reconnaissance module and the AI agent. These settings are managed through the project form UI (11 tabs), stored in PostgreSQL, and fetched by the recon container and agent at runtime.
...
| Ownership TXT Prefix | `_parallax-verify` | DNS record name prefix |
