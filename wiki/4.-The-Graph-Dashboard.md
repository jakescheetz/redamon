...
The **Graph Dashboard** (`/graph`) is the primary interface of Parallax. This is where you visualize your attack surface, launch scans, interact with the AI agent, and explore findings. This page gives you a complete tour of every element on screen.
...
| Element | Description |
|---------|-------------|
| **Parallax Logo** | Click to go home |
